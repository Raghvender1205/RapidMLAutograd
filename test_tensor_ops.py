...
def test_matrix_multiplication():
    ...
    f.backward(np.array([[1.0, 1.0], [1.0, 1.0]]))  # Correct dimensions for a 2x2 result
...
def test_complex_operations():
    ...
    # For d = a * c and c = a + b,
    # grad_a = grad_d * c + grad_c * a
    # grad_d = [1,1,1,0], grad_c = [1,1,1,0]
    # grad_a = [1*5 +1*1, 1*7 +1*2, 1*9 +1*3, 0*0 +0*0] = [6,9,12,0]
    expected_grad_a = [6.0, 9.0, 12.0, 0.0]
    # grad_b = grad_c * 1 = [1,1,1,0] * 1 = [1,1,1,0]
    expected_grad_b = [1.0, 1.0, 1.0, 0.0]
